...
public class LogWriterQueueHandlerByUserId implements CorrelationStrategy {
    ...
    @Bean
    public IntegrationFlow logFlowByUserId(ConnectionFactory connectionFactory) {
    ...
    public Object getCorrelationKey(Message<?> message) {
        ...
        if (message.getPayload() instanceof LogDto) {
            var userId = ((LogDto) message.getPayload()).getUserId();
